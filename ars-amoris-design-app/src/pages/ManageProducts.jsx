	...
	return (
		<>
			...
			<div className='flex flex-row flex-wrap px-2'>
				<div
					className='box-content group hover:box-content cursor-pointer m-2 hover:border-slate-50 hover:border-8 hover:p-0 bg-slate-50 rounded-xl p-3 shadow-2xl text-9xl flex items-center justify-center hover:bg-gradient-to-r hover:from-blue-300 hover:to-blue-600 border-0 duration-300 transition-all'
					style={{ width: 364.641, height: 336 }}
					...
					<svg viewBox='0 -0.5 25 25' width='200px' height='200px' fill='none' xmlns='http://www.w3.org/2000/svg'>
						<g id='SVGRepo_iconCarrier'>
							<path
								...
								className='group-hover:stroke-slate-50 stroke-blue-500 transition-colors duration-300'
							></path>
							<path
								...
								className='group-hover:fill-slate-50 fill-blue-500 transition-colors duration-300'
							></path>
						</g>
					</svg>
				</div>
