...
export default function AuthenticationMenu() {
	...
	return (
		<div className='relative order-3 ml-auto'>
			...
			<nav
				className={`${isOpen ? 'opacity-100' : 'opacity-0'} absolute right-0 translate-y-1 justify-center divide-y text-nowrap rounded bg-slate-50 text-center font-medium shadow-md transition-all duration-300 md:static md:right-0 md:flex md:translate-y-0 md:divide-y-0 md:rounded-none md:bg-white md:opacity-100 md:shadow-none`}
			>
				{!isAuthenticated ? (
					<>
