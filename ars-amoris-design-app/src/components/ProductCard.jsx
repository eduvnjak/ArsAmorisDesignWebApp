export default function ProductCard({ name, price, imageUrl, showDetails }) {
	return (
		<div className='m-2 bg-slate-50 rounded-xl p-3 shadow-2xl text-center'>
			...
			<button
				className='transition-colors duration-300 hover:border-red-500 hover:border-4 hover:p-3 mx-auto p-4 font-medium hover:from-white hover:to-white hover:text-red-500 text-white bg-gradient-to-l from-red-400 to-red-500 shadow-md rounded-full border-0'
				onClick={showDetails}
			>
				Pogledaj detalje
			</button>
